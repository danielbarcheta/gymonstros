      ...
      <div className="flex flex-col lg:flex-row lg:justify-between">
        <div>
          ...
          <div className="font-md">
            Seu corpin atinge o que a mente acredita!
          </div>
        ...
        <div className="flex flex-col w-full justify-between sm:flex-row  md:w-3/4 md:justify-evenly">
          <div className="flex flex-col w-48 gap-2 mt-6 md:mt-0 xl:w-64">
            <div className="flex items-center gap-1">
              ...
              <p className="text-lg font-medium uppercase">Sobre</p>
            </div>
          ...
          <div className="flex flex-col gap-2 mt-6 md:mt-0">
            <div className="flex items-center gap-1">
              ...
              <p className="text-lg font-medium uppercase">Horário de Funcionamento</p>
            </div>
          ...
          <div className="flex flex-col gap-2 mt-6 md:mt-0">
            <div className="flex items-center gap-1">
              ...
              <p className="text-lg font-medium uppercase">Localização</p>
            </div>
            <p className="text-base font-thin">
              Av Paulista <br />
            </p>
        ...
        <div className="flex flex-col mt-6 md:mt-0">
          ...
          <small className="mt-6 text-right">
            &copy; Copyright 2023, GymMonstros
          </small>
        </div>
      </div>
    </footer>
